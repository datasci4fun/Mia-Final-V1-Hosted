...
AS $$
DECLARE
  project_url TEXT := 'https://cpcywuhcqlkjdfwqibyi.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNwY3l3dWhjcWxramRmd3FpYnlpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNjYxMTQzNSwiZXhwIjoyMDQyMTg3NDM1fQ.uk7XX3q6_oCMBZpMnGvab9R-6iaSuPawULVmQ52Slys'; -- full access needed for http request to storage
