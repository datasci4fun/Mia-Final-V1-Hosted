...
interface ChatUIProps {
  handleNavigation?: (path: string) => void // Optional prop for handling navigation
}

export const WidgetChatUI: FC<ChatUIProps> = ({ handleNavigation }) => {
  ...
  }, [params.chatid]) // Add dependency to rerun when chat ID changes
