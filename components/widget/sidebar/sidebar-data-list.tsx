...
import { CollectionItem } from "@/components/sidebar/items/collections/collection-item"
import { FileItem } from "@/components/sidebar/items/files/file-item"
import { Folder } from "@/components/sidebar/items/folders/folder-item"
import { ModelItem } from "@/components/sidebar/items/models/model-item"
import { PresetItem } from "@/components/sidebar/items/presets/preset-item"
import { PromptItem } from "@/components/sidebar/items/prompts/prompt-item"
import { ToolItem } from "@/components/sidebar/items/tools/tool-item"
...
export const SidebarDataList: FC<SidebarDataListProps> = ({
  ...
  const handleItemClick = (item: DataItemType) => {
    const path = `/${contentType}/${item.id}`
    handleNavigation(path) // Use handleNavigation function for navigation
  }
